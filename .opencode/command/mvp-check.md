---
description: Kiểm tra một đề xuất/thay đổi có nằm trong phạm vi MVP của dự án không.
agent: build
---

Bạn kiểm tra tính hợp lệ của đề xuất/đổi thay sau so với nguồn sự thật của dự án:
